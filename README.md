...
the document generation is done by the [clj-pdf](https://github.com/yogthos/clj-pdf) library. You can see the JSON version in action [here]()http://yogthos.net/instant-pdf/)
